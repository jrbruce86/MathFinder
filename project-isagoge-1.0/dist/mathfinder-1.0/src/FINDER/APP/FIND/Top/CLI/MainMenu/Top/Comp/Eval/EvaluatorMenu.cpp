...
void EvaluatorMenu::doTask() {
  ...
  std::cout << "Evaluation can either be run on the result of a single group of one or "
      ...
      << "directory should contain a single file ending with .rect which contains the results. The "
      ...
      << "directory must also contain the original images on which the Math Finder was run."
