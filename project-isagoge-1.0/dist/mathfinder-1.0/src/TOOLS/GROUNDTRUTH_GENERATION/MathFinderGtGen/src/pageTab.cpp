...
// Author - whitedg
//
// Modified by Jake Bruce 2013, then in 2016
//
...
pageTab::pageTab(int count, string imgPath = "", string txtPath = "")
: resizeFactor((float)1), scaled_width(1000)
{
  textPath = txtPath;
  imagePath = imgPath;
  index = count;
...
bool pageTab::isRectFile() {
  return curState == "text";
}

bool pageTab::isImageFile() {
  return curState == "img";
}
