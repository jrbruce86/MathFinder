...
# Third-party autotools projects
TESSDIR=$TOPDIR/src/THIRDPARTY/Tesseract
DLIBDIR=$TOPDIR/src/THIRDPARTY/dlib-18.4

# My common autotools project
COMMONDIR=$TOPDIR/src/FINDER/COMMON

echo -e "------------------------\nRunning Tesseract autogen.sh\n------------------------"
cd $TESSDIR
#./autogen.sh
#./configure

echo -e "------------------------\nRunning DLib autogen.sh\n------------------------"
cd $DLIBDIR
#./autogen.sh
#./configure

echo -e "------------------------\nRunning COMMON autogen.sh\n------------------------"
cd $COMMONDIR
#./autogen.sh
#./configure

echo -e "------------------------\nRunning APPS autogen.sh\n------------------------"
cd $TOPDIR
#!/bin/sh
