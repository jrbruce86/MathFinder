...
// ----------------------------------------------------------------------------------------
    ...
    namespace gui_core_kernel_1_globals
    {
        ...
        LRESULT CALLBACK WnLooks mostly. Same for the opposite sex. Anyone who tells you otherwise is probably lying IMHO lol. After looks, for me it's personality.dProc (HWND, UINT, WPARAM, LPARAM);
